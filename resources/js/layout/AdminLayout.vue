        ...
        <div class="flex-1 flex flex-col pb-4">
          <div class="flex items-center flex-shrink-0 bg-gray-900 py-4 px-4 mb-4">
            <a href="/admin" class="text-white">
              <span class="text-xl font-semibold font-mono text-teal-500">Testo</span>
            ...
            <a href="#" class="flex-shrink-0 block focus:outline-none">
              <div class="flex items-center">
                ...
                <div class="ml-3">
                  ...
                  <p class="text-xs leading-4 font-medium text-gray-400 transition ease-in-out duration-150">修改资料</p>
                </div>
              </div>
            </a>
          </div>
          <nav class="flex-1 mt-5 bg-gray-800">
            <router-link :to="{name: 'admin.dashboard'}" class="group mb-1 flex items-center px-6 py-2 text-sm leading-6 focus:outline-none transition ease-in-out duration-150" :class="[currentMenu === 'dashboard' ? 'bg-gray-700 text-white' : 'text-gray-300 hover:text-white hover:bg-gray-700 focus:bg-gray-700']">
            ...
            <router-link :to="{name: 'admin.subject.index'}" class="group mb-1 flex items-center px-6 py-2 text-sm leading-6 focus:outline-none transition ease-in-out duration-150"  :class="[currentMenu === 'subject' ? 'bg-gray-700 text-white' : 'text-gray-300 hover:text-white hover:bg-gray-700 focus:bg-gray-700']">
              <svg class="w-6 h-6 stroke-current" fill="none" viewBox="0 0 24 24">
            ...
            <a href="#" class="group mb-1 flex items-center px-6 py-2 text-sm leading-6 focus:outline-none focus:bg-gray-700 hover:text-white hover:bg-gray-700 transition ease-in-out duration-150 text-gray-300">
              <svg class="w-6 h-6 stroke-current" fill="none" viewBox="0 0 24 24">
