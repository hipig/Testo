      ...
      <div class="bg-gray-800 w-64 flex flex-col">
        <div class="flex-1 flex flex-col pb-4">
          ...
          <nav class="flex-1 mt-5 bg-gray-800">
            ...
            <a href="#" class="group mb-1 flex items-center px-6 py-2 text-sm leading-6 focus:outline-none transition ease-in-out duration-150" :class="[currentMenu === 'about' ? 'bg-gray-700 text-white' : 'text-gray-300 hover:text-white hover:bg-gray-700 focus:bg-gray-700']">
              <svg class="w-6 h-6 stroke-current" fill="none" viewBox="0 0 24 24">
