          ...
          <div class="w-48 max-h-screen mr-5">
            <div class="bg-white py-5 shadow rounded-lg">
              <div class="flex flex-col">
                <div class="flex items-center py-2 px-8 cursor-pointer" :class="[currentMenu === 'learn' ? 'bg-gray-100' : '']" @click="toRouter('my.learn')">
                ...
                <div class="flex items-center py-2 px-8 cursor-pointer" :class="[currentMenu === 'info' ? 'bg-gray-100' : '']" @click="toRouter('my.index')">
