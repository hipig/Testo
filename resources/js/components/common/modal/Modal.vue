<template>
  <div class="z-10">
    ...
    >
      <div class="fixed inset-0 transition-opacity bg-black bg-opacity-25 z-30" v-show="visible" @click="handleMaskClick"></div>
    </transition>
    <div class="fixed bottom-0 inset-x-0 px-4 pb-4 sm:inset-0 sm:flex sm:items-center sm:justify-center z-40" v-show="wrapShow" @click.self="handleWrapperClick">
      <transition
