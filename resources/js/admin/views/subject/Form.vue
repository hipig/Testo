    ...
    <div class="flex flex-col py-4">
      <div class="shadow rounded-md bg-white overflow-hidden">
        ...
        <div class="px-6 py-3 flex justify-center items-center bg-gray-50">
          ...
          <button type="button" class="inline-flex items-center justify-center font-medium leading-tight border focus:outline-none focus:shadow-outline-gray rounded-md px-6 py-2" @click="$router.go(-1)">返回</button>
        </div>
      </div>
    </div>
  </div>
...
<script>
  import { getSubjectsTree, showSubjects, storeSubjects, updateSubjects } from "@/admin/api/subject"
