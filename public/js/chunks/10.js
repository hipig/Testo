                ...
                _vm._l(_vm.bankList, function(item, index) {
                  return _c("tr", { key: index }, [
                    ...
                    _c(
                      ...
                      [_vm._v(_vm._s(item.subject.title))]
                    ),
                    _vm._v(" "),
                    _c(
                      "td",
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "px-6 py-3 border-t border-gray-200 whitespace-no-wrap font-semibold"
                      },
                      [_vm._v(_vm._s(_vm.bankTypeMap[item.type]))]
                    ),
                    _vm._v(" "),
                    _c(
                      "td",
                    ...
                    _c(
                      ...
                      [_vm._v(_vm._s(item.total_score))]
                    ),
                    _vm._v(" "),
                    _c(
                      "td",
                    ...
                    _c(
                      ...
                      [
                        _c(
                          "div",
                          { staticClass: "flex flex-wrap items-center -mx-1" },
                          [
                            _c(
                              "button",
                              {
                            ...
                            _c(
                              ...
                              {
                                staticClass:
                                  "px-1 text-yellow-500 hover:text-yellow-700 focus:outline-none",
                                attrs: { type: "button" },
                                on: {
                                  click: function($event) {
                                    return _vm.handleUpdateItem(item)
                                  }
                                }
                              },
                              [_vm._v("更新题目")]
                  ...
                  _c(
                    ...
                    [
                      _c("empty-data", {
                        ...
                        attrs: {
                          show:
                            _vm.isLoading === false && _vm.bankList.length === 0
                        }
                      })
                    ],
                    1
